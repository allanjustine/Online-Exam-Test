...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="{{url('/')}}" class="logo" style="background-color:#192A53;border:none;border-bottom:1px solid #14213f">
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg">
        @if ($setting)
        <img src="{{asset('/images/logo/'.$setting->logo)}}" class="ad-logo img-responsive" alt="SMCT Logo">
        @endif
      </span>
    </a>
    <!-- Header Navbar -->
          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu notif">
              @if (count($notify)>0)
                  ...
                  <li>
                    <a href="javascript:ajaxCall('{{route('exam.result', ['id' => $key->id])}}','exam-result')">
                      <div class="row" style="padding: 10px 5px">
                        <div class="col-sm-3"><div class="profile-circle-ex" ><p>{{substr($key->name,0,1)}}</p></div></div>
                  ...
                  @endforeach
              @else
              <center><li><p class="text-md text-muted">No Notification</p></li></center>
              @endif
            </ul>
          </li>
          <li style="color: dimgray;">
            <!-- Menu Toggle Button -->
            <a href="#" class="dropdown-toggle" data-toggle="dropdown" style="border:none ;color:rgb(74, 74, 75)">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <!-- Sidebar Menu -->
      <center><p class="text-muted">MAIN MENU</p></center>
      ...
      <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="treeview {{ $examinees }}">
              ...
              <ul class="treeview-menu">
                  <li id='examinees' class="{{ $examinees }}">
                      <a href="javascript:ajaxCall('{{ url('/admin/examinees') }}', 'examinees')" title="Examinees">
                          <i class="fa fa-user"></i> <span>EXAMINEES</span>
                      </a>
                  </li>
                  <li id='adminlist'>
                      <a href="javascript:ajaxCall('{{ url('/admin/admin_list') }}', 'adminlist')" title="Administrators">
          ...
          <li id='questions' class="{{ $questions }}">
              <a href="javascript:ajaxCall('{{ url('admin/questions') }}', 'questions')" title="Questions">
