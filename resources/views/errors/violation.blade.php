            ...
            <div class="row" >
                <div class="col-md-6 flexybox">
                    <div style="margin: auto">
                        ...
                        <a href="https://smctgroup.com/" class="btn btn-primary"> Visit our Site</a>
                    </div>
                    
                </div>
                <div class="col-md-6">
                    <img src="{{asset('/images/vectors/violation.png')}}" class="img-responsive" width="80%" alt="expired link">
                </div>
            </div>
    </div>
</body>
